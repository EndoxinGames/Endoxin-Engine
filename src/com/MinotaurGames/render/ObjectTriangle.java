...
public class ObjectTriangle extends ObjectGeometric {
	ObjectLine A;
	ObjectLine B;
	ObjectLine C;
	
	public ObjectTriangle(ObjectLine a, ObjectLine b, ObjectLine c) throws IllegalGeometryException {
	...
	public ObjectTriangle(ObjectVertex a, ObjectVertex b, ObjectVertex c) {
